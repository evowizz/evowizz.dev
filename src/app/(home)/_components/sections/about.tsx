  ...
  <section id="about" className="scroll-mt-20 py-28 md:py-40">
    <Container className="flex flex-col gap-12 md:gap-16">
      ...
      <Reveal className="flex max-w-[44rem] flex-col gap-6 text-lg leading-relaxed md:text-xl">
        ...
        <p className="text-on-surface">
          I&apos;m a self-taught developer and designer in Nantes, France, building for Android since 2016. In 2018 I
        ...
        <p className="text-on-surface-variant">
          In 2024 I joined Beeper, where I was both a designer and a developer on their Android app. Among other things,
          I rewrote the app&apos;s navigation and rebuilt its color system around Material 3.
        </p>
        <p className="text-on-surface-variant">
